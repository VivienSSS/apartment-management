...
export enum UsersTblRoleOptions {
	"landlord" = "landlord",
	"tenant" = "tenant",
	"maintenance" = "maintenance",
}
export type UsersTblRecord = {
	age: number;
	created?: IsoDateString;
	email: string;
	firstname: string;
	...
	middlename: string;
	password: string;
	role?: UsersTblRoleOptions;
	rooms_rented?: RecordIdString[];
	updated?: IsoDateString;
};
...
export type BillingInfoTblResponse<Texpand = unknown> =
	& Required<BillingInfoTblRecord>
	& BaseSystemFields<Texpand>;
export type BillingInfoUtilitiesDateTblResponse<Texpand = unknown> =
	& Required<BillingInfoUtilitiesDateTblRecord>
	& BaseSystemFields<Texpand>;
export type BillingTblResponse<Texpand = unknown> =
	& Required<BillingTblRecord>
	& BaseSystemFields<Texpand>;
export type RoomsTblResponse<Texpand = unknown> =
	& Required<RoomsTblRecord>
	& BaseSystemFields<Texpand>;
export type ScheduleTblResponse<Texpand = unknown> =
	& Required<ScheduleTblRecord>
	& BaseSystemFields<Texpand>;
export type TenantsInformationResponse<Texpand = unknown> =
	& Required<TenantsInformationRecord>
	& BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> =
	& Required<UsersRecord>
	& AuthSystemFields<Texpand>;
export type UsersTblResponse<Texpand = unknown> =
	& Required<UsersTblRecord>
	& BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
	...
	collection(
		idOrName: "billing_info_tbl",
	): RecordService<BillingInfoTblResponse>;
	collection(
		idOrName: "billing_info_utilities_date_tbl",
	): RecordService<BillingInfoUtilitiesDateTblResponse>;
	...
	collection(
		idOrName: "tenants_information",
	): RecordService<TenantsInformationResponse>;
	collection(idOrName: "users"): RecordService<UsersResponse>;
	collection(idOrName: "users_tbl"): RecordService<UsersTblResponse>;
};
